            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="editable editable-click" data-id="<?php echo $menu['id']; ?>" data-name="sort_num" data-type="text" data-pk="<?php echo $menu['id']; ?>" data-url="<?php echo url('editable'); ?>">
                                <?php echo $menu['sort_num']; ?></a></td>
                        <td>
