...
<div class="row">
    <div class=" col-lg-12 col-sm-12">
        ...
        <div class="pull-right">
            ...
            <a class="btn btn-primary" href="<?php echo url('admin/channel/addcontent?'); ?>">添加内容</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="editable editable-click" data-id="<?php echo $item['id']; ?>"
                               ...
                               data-pk="<?php echo $item['id']; ?>" data-url="<?php echo url('editcontent'); ?>">    <?php echo $item['title']; ?>
                            </a>
                        </td>
                        <td>
                            <?php echo datefmt("Y-m-d H:i",$item['create_time']); ?>
                        </td>
                        <td>
                            <?php echo datefmt("Y-m-d H:i",$item['publish_time']); ?>
                        </td>
                        <td>
                            <a href="#" data-type="select" data-pk="<?php echo $item['id']; ?>"
                               data-url="<?php echo url('editcontent'); ?>" select-val="<?php echo $item['status']; ?>" data-name="status" data-title="审核"
                               class="edit_status" >
                            </a>

                        </td>
                        <td>
                            <a href="<?php echo url('admin/channel/addcontent?id='.$item['id']); ?>" >编辑</a>
